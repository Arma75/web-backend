...
import com.buds.project1.common.dto.PageRequest;

public class FoodNutrientRequest extends PageRequest {
    private Long id;
    ...
    public void validate(boolean isPatch) {
        // 필수 값 체크
        if (!isPatch && (this.getFood() == null || this.getFood().isBlank())) {
